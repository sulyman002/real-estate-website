...
export const Discover = () => {
  return (
    <div
      ...
      className="h-[750.78px] w-full flex items-center justify-center flex-col text-center gap-4"
    >
      <h1 className="w-[592.92px] text-[60px] font-500 font-bold  leading-[78px]">
        Discover a place you'll love to live
      </h1>
      <p className="w-[475.63px] font-400 text-[16px] leading-[30.4px]">
